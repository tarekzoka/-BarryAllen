...
# ===========================================================================================================================
# Command: wget --no-check-certificate https://raw.githubusercontent.com/tarekzoka/BarryAllen/main/installer.sh -O - | /bin/sh #
# ===========================================================================================================================
...
echo "**  https://www.tunisia-sat.com/forums/threads/3060281/post-1051520726   **"
echo "***************************************************************************"
echo ''
...
echo $MY_SEP
echo ''
wget -T 2 --no-check-certificate $MY_URL -P "/tmp/"
...
if [ -f $MY_TMP_FILE ]; then
	...
	if which dpkg > /dev/null 2>&1; then
		apt-get update
		# dpkg -i --force-overwrite $MY_TMP_FILE -y
